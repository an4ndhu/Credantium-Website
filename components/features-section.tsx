...
export function FeaturesSection() {
  ...
  return (
    <section id="features" ref={sectionRef} className="relative z-10">
      <div className="bg-white rounded-[2rem] sm:rounded-[3rem] pt-14 sm:pt-24 pb-14 sm:pb-24 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="md:hidden">
            <div
              ref={scrollRef}
              className={`flex overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-4 -mx-4 px-4 pr-5 transition-all duration-1000 delay-300 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
              }`}
            ...
            >
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="flex-shrink-0 snap-center w-[88vw] mr-4 last:mr-0"
                >
